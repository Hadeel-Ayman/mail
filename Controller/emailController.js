...
exports.mail = async (req, res, next) => {
    ...
    try {
        ...
        let mailOptions = {
            from: `"${newContact.username}" <${newContact.email}>`, 
            ...
            html: `
             ...
             <p>Project Details /<br>Description of project: ${newContact.projectDescription}<br>Competitors: ${newContact.composition}<br>Target group: ${newContact.targetGroup}<br>Vision: ${newContact.vision}<br>Competitive advantage: ${newContact.offer}<br>Project status: ${newContact.projectStatus}<br>Business serves: ${newContact.business}<br>Project name chosen: ${newContact.projectOption}</p>
